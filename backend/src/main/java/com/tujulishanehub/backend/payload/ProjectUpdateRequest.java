...
public class ProjectUpdateRequest {
    ...
    private List<ProjectCreateRequest.LocationRequest> locations;
    ...
    public List<ProjectCreateRequest.LocationRequest> getLocations() {
        return locations;
    }

    public void setLocations(List<ProjectCreateRequest.LocationRequest> locations) {
